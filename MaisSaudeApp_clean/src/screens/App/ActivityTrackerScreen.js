                ...
                <View style={[styles.statsRow, { marginTop: 20, justifyContent: 'space-around', paddingHorizontal: 30 }]}>
                    {
                        (() => {
                            ...
                            const steps = Math.round(distanceMeters / 0.78) || 0; // approx step length 0.78m
                            return (<><StatBox label="Calorias" value={isActive ? calories : 0} unit="kcal" isBig /><StatBox label="Passos" value={isActive ? steps : 0} unit="" isBig /></>);
                        })()
                    }
                </View>
